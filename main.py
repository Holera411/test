...
IMAGE_PETH = "Goose"
PLAYER_IMAGES = os.listdir(IMAGE_PETH)
...
def creat_enemy():    
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(30, HEIGHT-120), *enemy_size)
...
while playing:
    ...
    for event in pygame.event.get():
        ...
        if event.type ==CHANGE_IMAGE:
            player = pygame.image.load(os.path.join(IMAGE_PETH, PLAYER_IMAGES[image_index])) 
            image_index += 1  
